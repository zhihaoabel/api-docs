...
export const TransactionInformation =  {
    ...
    data: [
        ...
        },
        {
            ...
            required: 'Yes',
            sign: 'No',
            desc: '国家。 请参考 <a class="plain-link" href="https://en.wikipedia.org/wiki/ISO_3166-1">ISO 3166</a> </br> <span class="custom-example"><span class="leading-text" >例如</span><span class="custom-example">美国是 US</span></span>',
        },
        {
            name: 'province',
            type: 'String',
            ...
            required: 'No',
            sign: 'No',
            desc: '州。 当国家是美国 (US)，</br>中国 (CN) 或加拿大 (CA) 时必填。</br>请参考 <a class="plain-link" href="https://en.wikipedia.org/wiki/ISO_3166-1">ISO 3166</a> </br> <span class="custom-example"><span class="leading-text" >例如</span><span class="custom-example">美属萨摩亚是 AS</span></span>',
        },
        {
            name: 'city',
            type: 'String',
